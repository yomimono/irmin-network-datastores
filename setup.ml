...
(* OASIS_START *)
(* DO NOT EDIT (digest: b92dd77ef83c9e0023a6342683ea9247) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "irmin-network-datastores";
                   ...
                   {
                      lib_modules =
                        ["Ipv4_macaddr_table"; "Macaddr_entry"; "Ipv4_key"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "irmin-network-datastores";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "irmin-network-datastores"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "test_ops.ml"});
               Executable
                 ({
                     cs_name = "test_table";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_table.ml"});
               Test
                 ({
                     cs_name = "test_ops";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\183\1917w\223\131\191%\145\168\2254\255\213\156\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
